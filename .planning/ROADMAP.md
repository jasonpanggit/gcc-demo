...
Plans:
- [ ] P6.1: Design index strategy for search (full-text, B-tree, GIN)
- [ ] P6.2: Design index strategy for filtering (composite indexes)
- [ ] P6.3: Design index strategy for cross-table joins (covering indexes, INCLUDE columns)
- [ ] P6.4: Design aggregation strategy (MVs vs inline CTEs vs partial indexes)
- [ ] P6.5: Design pagination strategy (keyset vs offset/limit)
