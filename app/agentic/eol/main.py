...
# ============================================================================
# 
# All cache management endpoints are now handled by cache_router
# See api/cache.py for:
# - GET /api/cache/status - Cache status across all agents
# - POST /api/cache/clear - Clear inventory caches
# - POST /api/cache/purge - Purge web scraping cache
# - And 14 additional advanced cache endpoints
