...
# NOTE: _SOURCE_GUIDANCE and _TOOL_DISAMBIGUATION were removed in Phase 7.
# Tool selection is now handled by the Planner (utils/planner.py) using
# ToolManifestIndex conflict notes. See utils/manifests/ for per-tool metadata.

_REMOVED_SENTINEL = True  # keeps line-count stable during diff review
